// Generated by falx from format `logfmt`. Do not edit by hand;
...
fn logfmt_blocks_dispatch(data: &[u8], sink: &mut LogfmtSink) {
    ...
    {
        // SAFETY: the required target features were just detected.
        unsafe { neon::logfmt_blocks(data, sink) };
        return;
    }
    unsupported_cpu()
}
...
mod neon {
    ...
    unsafe fn step(ptr: *const u8, carries: &mut [u64; 2]) -> (u64, u64) {
        ...
        let v7 = { let parity = prefix_xor(v6) ^ carries[1]; carries[1] = ((parity as i64) >> 63) as u64; parity };
        let v8 = !v7;
        let v9 = eq_mask(b0, b1, b2, b3, 10u8) | eq_mask(b0, b1, b2, b3, 32u8) | eq_mask(b0, b1, b2, b3, 61u8); // class "\n ="
        let v10 = v9 & v8;
